...
const es: Dict = {
  ...
  referencias: {
    ...
    items: [
      ...
      { name: "Junta de Castilla-La Mancha", scope: "Detección por barreras láser con avisos automáticos para la seguridad vial." },
...
const en: Dict = {
  ...
  gama: {
    ...
    items: [
      ...
      },
      {
        ...
        refs: ["Junta de Castilla y León — laser barrier system"],
      },
      {
  ...
  referencias: {
    ...
    items: [
      ...
      { name: "Junta de Castilla-La Mancha", scope: "Detection via laser barriers with automatic warnings for road safety." },
...
const pt: Dict = {
  ...
  gama: {
    ...
    items: [
      ...
      },
      {
        ...
        refs: ["Junta de Castilla y León — sistema de barreiras laser"],
      },
      {
  ...
  referencias: {
    ...
    items: [
      ...
      { name: "Junta de Castilla-La Mancha", scope: "Deteção por barreiras laser com avisos automáticos para a segurança rodoviária." },
  ...
  gama: {
    ...
    items: [
      ...
      },
      {
        ...
        refs: ["Junta de Castilla y León — sistema de barreres làser"],
      },
      {
