...
const es: Dict = {
  ...
  plataforma: {
    ...
    subtitle: ["AVIZOR Fauna no es meramente un nuevo equipamiento en la carretera, sino que es una solución integral de hardware propio y software, específicamente diseñado para el cuidado de la fauna y la protección de vidas en la carretera.", "La tarjeta de control es la pieza de hardware común a todas las soluciones, con inteligencia embebida para decidir y activar señales, relés y comunicar información. Constituye, por tanto, el corazón del sistema y, al ser de diseño y fabricación propia, adaptable y evolucionable.", "AVIZOR Cloud, la plataforma, es la que agrega, depura y presenta los datos, con capacidad para almacenar y analizar los tránsitos de fauna. De este modo, devuelve a la administración una lectura clara del riesgo. La señalización protege hoy; el dato permite planificar mañana."],
...
const en: Dict = {
  ...
  plataforma: {
    ...
    subtitle: ["AVIZOR Fauna is not merely a new piece of roadside equipment, but a comprehensive solution of proprietary hardware and software, specifically designed for the care of wildlife and the protection of lives on the road.", "The control board is the hardware common to every solution, with embedded intelligence to make decisions, activate signs and relays and communicate information. It is therefore the heart of the system and, being designed and manufactured in-house, adaptable and able to evolve.", "AVIZOR Cloud, the platform, is what aggregates, cleans and presents the data, with the capacity to store and analyse wildlife crossings. In this way, it gives the authorities a clear reading of the risk. Signage protects today; data lets you plan for tomorrow."],
...
const pt: Dict = {
  ...
  plataforma: {
    ...
    subtitle: ["A AVIZOR Fauna não é apenas um novo equipamento na estrada, mas sim uma solução integral de hardware próprio e software, especificamente concebida para o cuidado da fauna e a proteção de vidas na estrada.", "A placa de controlo é a peça de hardware comum a todas as soluções, com inteligência embebida para decidir e ativar sinais e relés e comunicar informação. Constitui, por isso, o coração do sistema e, por ser de conceção e fabrico próprios, adaptável e evolutiva.", "O AVIZOR Cloud, a plataforma, é quem agrega, depura e apresenta os dados, com capacidade para armazenar e analisar os trânsitos de fauna. Deste modo, devolve à administração uma leitura clara do risco. A sinalização protege hoje; os dados permitem planear amanhã."],
...
const ca: Dict = {
  ...
  plataforma: {
    ...
    subtitle: ["AVIZOR Fauna no és merament un nou equipament a la carretera, sinó que és una solució integral de hardware propi i software, específicament dissenyada per a la cura de la fauna i la protecció de vides a la carretera.", "La targeta de control és la peça de hardware comuna a totes les solucions, amb intel·ligència integrada per decidir i activar senyals i relés i comunicar informació. Constitueix, per tant, el cor del sistema i, en ser de disseny i fabricació propis, adaptable i evolucionable.", "AVIZOR Cloud, la plataforma, és la que agrega, depura i presenta les dades, amb capacitat per emmagatzemar i analitzar els trànsits de fauna. D'aquesta manera, retorna a l'administració una lectura clara del risc. La senyalització protegeix avui; la dada permet planificar demà."],
  ...
  referencias: {
    ...
    items: [
      ...
      { name: "DGT", scope: "Les nostres solucions estan preparades per integrar-se en els protocols de la Direcció General de Trànsit — presentació de la balisa de detecció i avís de fauna, preparada per connectar-se amb els sistemes de trànsit del futur.", points: ["Balises de control i dissuasòries: en apropar-se un vehicle, avisen el conductor i espanten la fauna amb llum i so. Només s'activen amb trànsit, així els animals creuen lliurement quan no n'hi ha.", "Tancament convencional combinat amb tecnologia: als passos de fauna, unes càmeres detecten l'animal i alerten el conductor.", "Tancament virtual: uns dispositius detecten els fars dels vehicles que s'acosten i emeten senyals per frenar l'animal, sense bloquejar el pas quan no hi ha trànsit."] },
    ],
  },
  contacto: {
    label: "Contacte",
